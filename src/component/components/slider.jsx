...
const VerticalSlider = () => {
  ...
  <main id="carousel">
    ...
    <div className="roundedcard">3</div>
      ...
      <span id="text" style={{marginTop:"40px"}}>
        <h2>
      <span style={{fontSize:"18px",fontWeight:"300"}}><b> 'In the realm of life experiences',</b>  </span> in this Crypto, blockchain, or web3, however, you may refer to it, it's safe to say that each of us carries our own unique blend of challenges (Pains) and triumphs (Gains). Here is my Story that inspired me to create this Outstanding Socialfi-Launchpad',
    ...
    <span id="text">
        <h2>
        <span style={{fontFamily:"Lobster",fontSize:"19px" ,textAlign:"center"}}>  'A Solitary Start in the World of Crypto'</span><p></p><p> My journey into the world of cryptocurrencies began in late 2019, fueled by the bitter experience of falling victim to high-yield investment program (hyip) scams that promised unrealistic returns. Back then, navigating the crypto space was a solitary endeavor, with no physical mentor to guide me. It was a time when crypto adoption was still in its infancy, and the risks were abundant.',</p>
